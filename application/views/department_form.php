                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('department/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="<?php echo display('department_name') ?>" value="<?php echo html_escape($department->name); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="<?php echo display('description') ?>" rows="7"><?php echo html_escape($department->description); ?></textarea>
                                </div>
                            </div>
