    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo base_url('dashboard_accountant/home/logout') ?>"><i class="pe-7s-power"></i> <?php echo display('logout') ?></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <footer class="main-footer">
                <?php echo ($this->session->userdata('footer_text')!=null?$this->session->userdata('footer_text'):null) ?>
            </footer>
        </div> <!-- ./wrapper -->
