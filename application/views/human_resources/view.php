                        ...
                        <?php if (!empty($employees)) { ?>
                            ...
                            <?php foreach ($employees as $employee) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><img src="<?php echo (!empty($employee->picture) ? base_url(html_escape($employee->picture)) : base_url("assets/images/no-img.png")) ?>" width="65" height="50"/></td>
                                    <td><?php echo html_escape($employee->firstname); ?></td>
                                    <td><?php echo html_escape($employee->lastname); ?></td>
                                    <td><?php echo html_escape($employee->email); ?></td>
                                    <td><?php echo html_escape($employee->phone); ?></td>
                                    <td><?php echo html_escape($employee->address); ?></td>
                                    <td><?php echo html_escape($employee->sex); ?></td>
                                    ...
                                    <td><?php echo html_escape($userRoles[$employee->user_role]) ?></td>
                                    <td><?php echo html_escape($employee->create_date); ?></td>
                                    <td><?php echo ((html_escape($employee->status)==1)?display('active'):display('inactive')); ?></td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
                        <?php } ?> 
