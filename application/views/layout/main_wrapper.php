...
<html lang="en">
    <head>
        ...
        <title><?php echo display('dashboard') ?> - <?php echo (!empty($title)?html_escape($title):null) ?></title>
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header"> 
                ...
                <?php $logo = html_escape($this->session->userdata('logo')); ?>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo base_url('logout') ?>"><i class="pe-7s-power"></i> <?php echo display('logout') ?></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
