                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('patient/document_form','class="form-inner" id="mailForm" ') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="patient_id"  type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id')?>" value="<?php echo (($this->uri->segment(3)!=null)?$this->uri->segment(3):html_escape($document->patient_id)) ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('doctor_id',$doctor_list,html_escape($document->doctor_id),'class="form-control" id="doctor_id"') ?>
