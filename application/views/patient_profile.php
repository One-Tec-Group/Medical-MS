                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <div class="row">
                            <div class="col-sm-3" align="center"> 
                                <img alt="Picture" src="<?php echo html_escape((!empty($profile->picture)?base_url($profile->picture):base_url("assets/images/no-img.png"))); ?>" class="img-thumbnail img-responsive img-hw-200">
                            ...
                            <div class="col-sm-9"> 
                                <dl class="dl-horizontal">
                                    ...
                                    <dt><?php echo display('date_of_birth') ?></dt><dd><?php echo date('d M Y',strtotime(html_escape($profile->date_of_birth))) ?></dd> 
                                    <dt><?php echo display('age') ?></dt><dd><?php echo date_diff(date_create(html_escape($profile->date_of_birth)), date_create('now'))->y; ?> Years</dd> 
